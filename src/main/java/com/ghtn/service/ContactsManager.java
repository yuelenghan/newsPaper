...
public interface ContactsManager extends GenericManager<Contacts, Long> {
     ...
     * @return 通讯录列表
     */
    List<Contacts> listContactsByPage(ContactsType contactsType, Integer page, Integer rows);
     ...
     * @return 通讯录列表
     */
    List<Contacts> listContactsByPage(List<ContactsType> contactsTypeList, Integer page, Integer rows);
     ...
     * @return 通讯录列表
     */
    List<Map<String, String>> getContactsByPage(ContactsType contactsType, Integer page, Integer rows);
